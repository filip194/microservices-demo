 ...
 * To create Kafka Template, we will need to create default Kafka ProducerFactory bean, and also create map as a bean
 * to hold and return Kafka configuration data related with the Kafka producer.
 *
 * @param <K> key
 * @param <V> value
 */
...
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecordBase>
{
    ...
    // KafkaTemplate<K, V> is a thread-safe template for executing high level producer operations.
